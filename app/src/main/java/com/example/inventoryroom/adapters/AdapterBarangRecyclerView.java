package com.example.inventoryroom.adapters;
...
import com.example.inventoryroom.R;
import com.example.inventoryroom.RoomCreateActivity;
import com.example.inventoryroom.entities.AppDatabase;
import com.example.inventoryroom.entities.Barang;
...
public class AdapterBarangRecyclerView extends RecyclerView.Adapter<AdapterBarangRecyclerView.ViewHolder> {
    ...
    public AdapterBarangRecyclerView(ArrayList<Barang> barangs, Context ctx){
        ...
        context = ctx;
        db = Room.databaseBuilder(context.getApplicationContext(), AppDatabase.class, "barangdb")
